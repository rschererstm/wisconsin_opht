...
print('Some fixes were made... (Rafael Scherer)')

parser = argparse.ArgumentParser()
parser.add_argument("--input", "-i", type=str, default='C:/Users/Usuario/PycharmProjects/wisconsin/samples/angio', help='test image folder')
parser.add_argument("--result", "-r", type=str, default='C:/Users/Usuario/PycharmProjects/wisconsin/output', help='result folder')
parser.add_argument("--model", "-m", type=str, default='Syn_img_lowlight', help='model name')
...
mbllen.load_weights('thirdparty/MBLLEN/models/'+model_name+'.h5')
...
for i in range(len(path)):
    ...
    img_name = result_folder + '/' + 'MBLLEN.jpg'
